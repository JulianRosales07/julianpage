        ...
        <div className="bg-white rounded-lg shadow-xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-primary-50 p-6 rounded-lg shadow-md">
              <h2 className="text-xl font-semibold text-primary-700 mb-3">Clientes</h2>
              <p className="text-gray-600">Gestiona la información de tus clientes</p>
            </div>
            <div className="bg-primary-50 p-6 rounded-lg shadow-md">
              <h2 className="text-xl font-semibold text-primary-700 mb-3">Vehículos</h2>
              <p className="text-gray-600">Administra los vehículos en servicio</p>
            </div>
            <div className="bg-primary-50 p-6 rounded-lg shadow-md">
              <h2 className="text-xl font-semibold text-primary-700 mb-3">Reparaciones</h2>
              <p className="text-gray-600">Seguimiento de reparaciones y servicios</p>
            </div>
            <div className="bg-primary-50 p-6 rounded-lg shadow-md">
              <h2 className="text-xl font-semibold text-primary-700 mb-3">Piezas</h2>
